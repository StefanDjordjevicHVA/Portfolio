package com.example.kotlinhighlow
...
class HigherLowerActivity : AppCompatActivity() {
    ...
    /**
     * Set initial (UI) state of the game
     */
    ...
    /**
     * Update the last throw text and the dice image resource drawable with the current context
     */
